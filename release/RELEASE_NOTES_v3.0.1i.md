# CPAP AutoSync v3.0.1i — Changelog

> **Note:** v3.0.1i is a minor UI update. The core firmware code and upload logic are identical to v3.0i-stable. The only change is an updated disconnect message in the Web UI to reassure AirSense 10 users about expected behavior.
...
**Upgrading from v2.x, v3.0i-gamma, or v3.0i-stable?** OTA update is supported — use the OTA tab in the web interface.

---

## 🚀 What's New in v3.0.1i

### UI/UX Improvements
- **AirSense 10 Disconnect Notice:** Added a dedicated banner to the Web UI's "Connection lost — reconnecting..." overlay. This banner informs AirSense 10 users that the CPAP intentionally resets the SD card every 60 seconds while blowing air, which causes expected temporary reboots during therapy. This reassures users that the device is functioning normally and will upload automatically once therapy stops.

---

## 🚀 What's New in v3.0i-stable
...
**For users upgrading from any v2.0i-alpha, v2.0i-beta, v3.0i-gamma, or v3.0i-stable:**
