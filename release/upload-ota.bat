@echo off
REM ESP32 OTA Firmware Initial Flash Script for Windows using esptool
...
set "FIRMWARE_FILE=firmware-ota.bin"
...
echo ========================================
echo Port: !PORT!
echo Firmware: OTA-enabled (web updates supported)
