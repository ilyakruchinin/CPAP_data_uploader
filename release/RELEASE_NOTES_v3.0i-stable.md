# CPAP AutoSync v3.0i-stable — Changelog

> **Note:** v3.0i-stable contains the exact same firmware code as v3.0i-gamma1. The only changes in this release are minor updates to the README documentation regarding model compatibility.
...
**Upgrading from v2.x or v3.0i-gamma?** OTA update is supported (**_but discouraged_**) — use the OTA tab in the web interface.
...
**For users upgrading from any v2.0i-alpha, v2.0i-beta, or v3.0i-gamma:**
