...
# sdkconfig.defaults is a build artifact (gitignored) generated by the hybrid
# compile from custom_sdkconfig entries. Our documented reference is sdkconfig.project.
